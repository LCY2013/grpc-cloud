module github.com/LCY2013/grpc-cloud/plugins/grpc-cloud-plugin-validate

go 1.21.3

require (
	buf.build/gen/go/bufbuild/protovalidate/protocolbuffers/go v1.31.0-20231106192134-1baebb0a1518.2 // indirect
	github.com/LCY2013/grpc-cloud/logger v0.0.0-20231106042551-8535e6f6ca95 // indirect
