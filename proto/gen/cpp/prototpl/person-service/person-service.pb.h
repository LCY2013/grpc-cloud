...
class PersonMessage final :
 ...
 public:
  ...
  public:
  // int32 age = 2 [json_name = "age", (.buf.validate.field) = {
  void clear_age() ;
  ::int32_t age() const;
...
inline ::int32_t PersonMessage::age() const {
  // @@protoc_insertion_point(field_get:grpc.person.service.v1.PersonMessage.age)
  return _internal_age();
}
inline void PersonMessage::set_age(::int32_t value) {
  _internal_set_age(value);
  // @@protoc_insertion_point(field_set:grpc.person.service.v1.PersonMessage.age)
}
inline ::int32_t PersonMessage::_internal_age() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.age_;
}
inline void PersonMessage::_internal_set_age(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.age_ = value;
}
